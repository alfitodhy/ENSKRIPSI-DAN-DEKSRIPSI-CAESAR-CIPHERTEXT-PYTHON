...
class CaesarApp:
    def __init__(self, master=None):
        ...
        toplevel1.configure(background="#d0e8ff",
        ...
        def decode():
            ...
            plaintext = ''
            for karakter in p:
            cbaru = chr((ord(karakter)-geser) % 256)
            plaintext += cbaru
            label2.configure(text='HASIL : ' + plaintext)
            return
        ...
        button2.configure(text='DECODE CAESAR CIPHER', command=decode)
